...
obj_SellNPC::obj_SellNPC() : obj_BaseNPC()
{
	...
	/*switch (u_random(6))
	{
	default:m_NPCAnimName = "Civ_Idle_03";
	case 0: m_NPCAnimName = "Idle_NPC_1";break;
	case 1:	m_NPCAnimName = "Idle_NPC_2";break;
	case 2:	m_NPCAnimName = "Idle_NPC_3";break;
	case 3:	m_NPCAnimName = "Idle_NPC_4";break;
	case 4:	m_NPCAnimName = "Idle_NPC_5";break;
	case 5:	m_NPCAnimName = "Civ_Idle_03";break;
	}*/
}