...
private:
	int		m_typeIndex;		// 0 - normal zombie, 1 - super zombie, 2 - super zombie mutant, 3 - super zombie berserker
...
public:
	...
	bool		IsSuperZombieMutant() { return m_typeIndex == 2; }
	bool		IsSuperZombieBerserker() { return m_typeIndex == 3; }
