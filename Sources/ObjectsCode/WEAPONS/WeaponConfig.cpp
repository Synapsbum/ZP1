...
bool WeaponConfig::loadBaseFromXml(pugi::xml_node& xmlWeapon)
{
	...
	m_spreadText = xmlWeapon.child("PrimaryFire").attribute("spread").as_float();
	m_recoilText = xmlWeapon.child("PrimaryFire").attribute("recoil").as_float();
	m_fireDelayText = xmlWeapon.child("PrimaryFire").attribute("rateOfFire").as_float();
	m_reloadTimeText = xmlWeapon.child("PrimaryFire").attribute("reloadTime").as_float();
