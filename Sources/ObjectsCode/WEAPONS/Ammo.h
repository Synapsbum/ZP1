...
public:
	...
	//const char* getShellExtractParticleName() const { return m_ShellExtractParticle; }//AlexRedd:: disabled for now! it might be a reason why ppls crashed with skeleton error
...
private:
	...
	//char*	m_ShellExtractParticle; // may be null //AlexRedd:: disabled for now! it might be a reason why ppls crashed with skeleton error
	char* m_DecalSource;
	char* m_BulletClass;
};
