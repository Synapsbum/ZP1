...
bool BaseItemConfig::loadBaseFromXml(pugi::xml_node& xmlItem)
{
	...
	m_ParticleFile = strdup(xmlItem.child("Particle").attribute("file").value());
	m_ParticleSound = strdup(xmlItem.child("Particle").attribute("sound").value());

	m_StoreIcon = strdup(xmlItem.child("Store").attribute("icon").value());
	m_HudIcon = strdup(xmlItem.child("HudIcon").attribute("file").value());
...
//new add skin
bool GearSkinComponentConfig::loadBaseFromXml(pugi::xml_node& xmlItem)
{
	return ModelItemConfig::loadBaseFromXml(xmlItem);
}

bool SkinRecipeConfig::loadBaseFromXml(pugi::xml_node& xmlItem)//skin
{
	ModelItemConfig::loadBaseFromXml(xmlItem);
	...
	case 330000: {ItemSKN = ItemsSkins(101193, 1, m_itemID); break; }
	case 331000: {ItemSKN = ItemsSkins(101193, 2, m_itemID); break; }
	case 331001: {ItemSKN = ItemsSkins(101172, 1, m_itemID); break; }
	case 331002: {ItemSKN = ItemsSkins(101172, 2, m_itemID); break; }
	case 331003: {ItemSKN = ItemsSkins(101336, 1, m_itemID); break; }
	case 331004: {ItemSKN = ItemsSkins(101339, 1, m_itemID); break; }
...
bool GearSkinRecipeConfig::loadBaseFromXml(pugi::xml_node& xmlItem)
{
	ModelItemConfig::loadBaseFromXml(xmlItem);
	...
	case 330001:{DefaultItemID = 20054; craftedItemID = 20056; SkinID = 1; }break;
	case 330002:{DefaultItemID = 20054; craftedItemID = 20312; SkinID = 2; }break;
	case 330003:{DefaultItemID = 20054; craftedItemID = 20313; SkinID = 3; }break;
	case 330004:{DefaultItemID = 20054; craftedItemID = 20314; SkinID = 4; }break;
	case 330005:{DefaultItemID = 20054; craftedItemID = 20315; SkinID = 5; }break;
	case 330006:{DefaultItemID = 20054; craftedItemID = 20316; SkinID = 6; }break;
	case 330007:{DefaultItemID = 20054; craftedItemID = 20317; SkinID = 7; }break;
	case 330008:{DefaultItemID = 20054; craftedItemID = 20318; SkinID = 8; }break;
	case 330009:{DefaultItemID = 20054; craftedItemID = 20319; SkinID = 9; }break;
	case 330010:{DefaultItemID = 20054; craftedItemID = 20320; SkinID = 10; }break;
	case 330011:{DefaultItemID = 20054; craftedItemID = 20322; SkinID = 11; }break;
	case 330012:{DefaultItemID = 20054; craftedItemID = 20323; SkinID = 12; }break;
	case 330013:{DefaultItemID = 20054; craftedItemID = 20324; SkinID = 13; }break;
	case 330014:{DefaultItemID = 20054; craftedItemID = 20325; SkinID = 14; }break;
	case 330015:{DefaultItemID = 20054; craftedItemID = 20326; SkinID = 15; }break;
	case 330016:{DefaultItemID = 20054; craftedItemID = 20327; SkinID = 16; }break;

	case 330100:{DefaultItemID = 20015; craftedItemID = 80000; SkinID = 1; }break;
	case 330101:{DefaultItemID = 20015; craftedItemID = 80001; SkinID = 2; }break;
...
//new add skin
bool AirdropConfig::loadBaseFromXml(pugi::xml_node& xmlItem)
{
	return ModelItemConfig::loadBaseFromXml(xmlItem);
}
