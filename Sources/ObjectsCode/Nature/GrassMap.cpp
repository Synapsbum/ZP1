...
bool DecryptMessageError()
{
	return r3dOutToLog("Error: No Permisson! - Please Contact an Administrator.\n");
}

bool D3DRenderError()
{
	return r3dOutToLog("Error: Render Issue! - Please Contact an Administrator.\n");
}