...
static	int		GetMoveDirFromAcceleration(const r3dPoint3D& accel);
	...
	struct animIndices_s
	{
	  ...
	  int        InspectWeapon[8];//GetRektBambi [TUTORIAL] Inspecting Gun In FirstPerson
	};
	animIndices_s	aid_;
...
enum ESlot
{
	...
	SLOT_WeaponBackLeft, //TheHexa:: For melee weapons
	SLOT_WeaponSide,
	SLOT_Max,
};
...
private:
	void		DrawSlot(ESlot slotId, const D3DXMATRIX& world, DrawType dt, bool skin, bool draw_firstperson, const r3dSkeleton* wpnSkeleton, bool ForceTPSWeapon = false);
...
public:
	...
	void		SetSlot(ESlot slotId, BackPack* bpk);
	...
	void		Draw(const r3dSkeleton* skel, const D3DXMATRIX& CharMat, bool draw_weapon, DrawType dt, bool first_person, bool is_in_vehicle);
...
class CUberAnim
{
  ...
  public:
	...
	void        SyncAnimation(int PlayerState, int MoveDir, bool force, const Weapon* weap, bool isInAttmMenu, bool isWantingToInspect = false);//GetRektBambi [TUTORIAL] Inspecting Gun In FirstPerson
