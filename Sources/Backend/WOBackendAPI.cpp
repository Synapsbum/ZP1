...
#if LOCAL
const char*	gDomainBaseUrl = "/ZP/api/";
...
void CWOBackendReq::Init(const char* url)
{
	...
	int success;
	success = http.UnlockComponent("wLiu9P.CB10599_JruQWlT4Da2k");
	if (success != 1)
	{
...
int CWOBackendReq::ParseResult(CkHttpResponse* resp)
{
	...
	{
		CkGzip gzip;
		if(gzip.UnlockComponent("wLiu9P.CB10599_JruQWlT4Da2k") == false)
