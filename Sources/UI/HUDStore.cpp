...
void HUDStore::eventStorePurchaseGPRequest(r3dScaleformMovie* pMovie, const Scaleform::GFx::Value* args, unsigned argCount)
{
	r3d_assert(argCount == 0);
	char url[256];
	sprintf(url, "https://www.zombie-hunters.com/?donate=1");
