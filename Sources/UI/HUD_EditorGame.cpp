...
const r3dPoint3D gCameraPosIdle(0.0f, -0.3f, -1.5f);
const r3dPoint3D gCameraPosIdleAim(0.0f, -0.3f, -1.5f);
const r3dPoint3D gCameraPosScope(0.0f, -0.4f, 0.0f);
const r3dPoint3D gCameraPosSprint(0.0f,-0.3f,-1.75f);

const r3dPoint3D gCameraPosCrouch(0.0f, -0.4f,-1.35f);
const r3dPoint3D gCameraPosCrouchAim(0.8f, -0.3f, -0.735f);
const r3dPoint3D gCameraPosCrouchScope(0.0f, -0.6f, 0.0f);

const r3dPoint3D gCameraPosProne(0.0f, -0.6f,-1.35f);
const r3dPoint3D gCameraPosProneAim(0.8f, -0.5f, -0.735f);
const r3dPoint3D gCameraPosProneScope(0.0f, -0.6f, 0.0f);

const r3dPoint3D gCameraPosVehicleDriver(0.0f, -2.5f, -4.0f);// from (0.0f, -2.5f, -10.0f);
const r3dPoint3D gCameraPosVehiclePassenger(0.0f, -2.5f, -4.0f);// from (0.0f, -2.5f, -10.0f);

// THIRD PERSON CAMERA, CROSS HAIR IN THE CENTER OF THE SCREEN!
const r3dPoint3D gCameraPosIdle2(0.5f, -0.2f, -1.5f);
const r3dPoint3D gCameraPosIdleAim2(0.5f, -0.16f, -1.5f);
const r3dPoint3D gCameraPosScope2(0.0f, -0.32f, 0.0f);
const r3dPoint3D gCameraPosSprint2(0.5f, -0.2f, -1.52f);
