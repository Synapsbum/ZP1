...
public:
	...
	void	setCarInfo(int durability, int speed, int armor, int weight, int gas, bool hasOwner, const char* ownername, int isLocked, bool isOwner, const char* lockText);
