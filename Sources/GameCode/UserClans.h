...
*/
  ...
  public:
	...
	struct ClanInfo_s
	{
	  ...
	  int		ClanPoints;//AlexRedd:: clan points system
	...
	int		ApiSetFriendlyFire(int ClanID, int value);//AlexRedd:: FriendlyFire system
	int		ApiSetClanPoints(int ClanID, int points);//AlexRedd:: Clan points
