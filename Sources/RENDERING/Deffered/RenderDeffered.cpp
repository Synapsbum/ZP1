...
void UpdateInternalScreenshot()
{
	...
	if( r_do_internal_screenshot->GetInt() && InternalScreenshotBuffer )
	{
		...
		sprintf(FileName, "ScreenInternal_%02d%02d%04d_%02d%02d%02d.tga", curdate.tm_mday, curdate.tm_mon + 1, 1900+curdate.tm_year, curdate.tm_hour, curdate.tm_min, curdate.tm_sec);
