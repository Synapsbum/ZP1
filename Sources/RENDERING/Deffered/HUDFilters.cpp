...
void InitHudFilters()
{
	...
	HUDFilterSettings &hfsMenu = gHUDFilterSettings[HUDFilter_Menu];
	//hfsMenu.filmGrain = 1;
	hfsMenu.SetAllColorCorrectionTexturesTo("DamegeHit.dds");
	hfsMenu.directionalStreaksOnOffCoef = 1.0f;
	hfsMenu.enableColorCorrection = true;
	hfsMenu.overrideHDRControls = 1;
	hfsMenu.hdrExposureBias = -1.0f;
	hfsMenu.overrideAmbientAndIntensity = 2;
	hfsMenu.overrideAmbient = r3dColor::white;
	hfsMenu.overrideIntensity = 0.0f;
